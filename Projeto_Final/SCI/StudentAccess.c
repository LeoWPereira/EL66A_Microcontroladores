...
// PRG          : SMART CARD READER      (Modified Added Fields)   
/*******************************************************************************/   
...
{   
 ...
 ClrLCD();    
 lprintf("Edit Data Mode  ",1,1);      
 lprintf("Pres:1->Y 2->NO",2,1);   
 ch=Get_Key(1);    
 if(ch=='1')   
 {   
  ClrLCD();   
  lprintf("Edit Mode",1,1);   
  Delay(100);   
  Write_Data();   
 }   
   
  ClrLCD();   
  lprintf("Access Mode",2,1);   
  Delay(100);   
  while(1)   
  {   
   ClrLCD();    
   lprintf("Plz. Insert CARD",1,1);    
   Chk_Card(1);                     //Check for the Card Insertition   
   lprintf("CARD Inserted...",1,1);   
   Delay(100);   
   Read_Data();   
   ClrLCD();    
   lprintf("Remove Card    ",1,1);   
   Chk_Card(0);                     //Check for the Card Removed   
   lprintf("CARD Removed    ",1,1);   
  }   
...
{   
 ...
 ClrLCD();   
 lprintf("Checking Card",1,1);    
 Chk_Card(1);                       //Check for the Card Insertition   
 LCD_Cmd(0xc0);   
   
 ClrLCD();   
 lprintf("Enter Rollno:",1,1);   
 LCD_Cmd(0xc0);   
 GetStr(std);   
 l=strln(std);   
 lprintf(std,2,8);   
 Write(RollNoAd,l,std);              //Writing 5 characters in 20h     
 lprintf("WritingComplete1",2,1);   
 Delay(200);   
    
 ClrLCD();   
 lprintf("Enter NAME:",1,1);   
 LCD_Cmd(0xc0);   
 GetStr(std);   
 l=strln(std);   
 lprintf(std,2,8);   
 Write(NameAd,l,std);                //Writing 5 characters in 20h    
 ClrLCD();     
 lprintf("WritingComplete2",2,1);   
 Delay(200);   
   
 ClrLCD();   
 lprintf("Enter Branch:",1,1);   
 LCD_Cmd(0xc0);   
 GetStr(std);   
 l=strln(std);   
 lprintf(std,2,8);   
 Write(BranchAd,l,std);              //Writing 5 characters in 20h    
 ClrLCD();     
 lprintf("WritingComplete3",2,1);   
 Delay(200);   
   
 ClrLCD();   
 lprintf("Enter College:  ",1,1);   
 LCD_Cmd(0xc0);   
 GetStr(std);   
 l=strln(std);   
 lprintf(std,2,8);   
 Write(CollegeAd,l,std);                 //Writing 5 characters in 20h    
 ClrLCD();     
 lprintf("WritingComplete4",2,1);   
 Delay(200);   
   
 ClrLCD();   
 lprintf("Enter Place :    ",1,1);   
 LCD_Cmd(0xc0);   
 GetStr(std);   
 l=strln(std);   
 lprintf(std,2,8);   
 Write(PlaceAd,l,std);               //Writing 5 characters in 20h    
 ClrLCD();     
 lprintf("WritingComplete5",2,1);   
 Delay(200);   
    
 ClrLCD();   
 lprintf("Enter Exp_Date :",1,1);   
 LCD_Cmd(0xc0);   
 GetStr(std);   
 l=strln(std);   
 lprintf(std,2,8);   
 Write(ExpDateAd,l,std);                 //Writing 5 characters in 20h    
 ClrLCD();     
 lprintf("WritingComplete6",2,1);   
 Delay(200);   
 ...
 std[4]='\0';   
 lprintf(std,2,8);   
 Write(PwdAd,4,std);                 //Writing 5 characters in 20h    
 ClrLCD();     
 lprintf("WritingComplete3",2,1);   
 Delay(200);   
 ClrLCD();     
