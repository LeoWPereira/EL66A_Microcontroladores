...
//////////////////////////////////////////////////////
// NOME: ESC_DADO_NUMERO_COMPLETO					//
// DESCRICAO: 										//
// P.ENTRADA: R1 -> qtdade de digitos do numero		//
//            A -> numero a ser convertido
// P.SAIDA: 										//
// ALTERA: 											//
//////////////////////////////////////////////////////
ESC_DADO_NUMERO_COMPLETO:       
		MOV 	B, #100d		// para poder calcular a velocidade em dezena
		DIV 	AB          	// armazena em A o valor da unidade
		LCALL	CONV_ASCII_TO_NUMBER
		LCALL	ESCDADO
